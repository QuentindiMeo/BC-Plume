...
// Seeks backward by seekDuration seconds, clamped to 0
export const seekBackward = (appCore: IAppCore, player: MusicPlayerPort): void => {
  const step = appCore.getState().seekDuration;
...
// Seeks forward by seekDuration seconds, clamped to track duration
