...
export enum PLUME_SVG {
  logo = `
    ...
    >
      <g>
        ...
        <g id="plume_feather">
          <g>
            <rect x="75.1" y="174.7" transform="matrix(0.1809 -0.9835 0.9835 0.1809 -41.9654 305.8548)" fill="#20A0C3" stroke="#1FA0C3" stroke-width="3" stroke-miterlimit="7.2021" width="175.1" height="6.8"/>
          </g>
          <g>
            <path
              fill="#20A0C3"
  ...
  loopNone = `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none">
      ...
      <path fill="currentColor" d="M20.707 3.293a1 1 0 0 0-1.414 0L3.293 19.293a1 1 0 1 0 1.414 1.414L20.707 4.707a1 1 0 0 0 0-1.414z"/>
    </svg>
  `,
  loopCollection = `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none">
